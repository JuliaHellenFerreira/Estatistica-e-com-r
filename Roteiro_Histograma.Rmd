...
*Também é possível alterar a estética do histograma. Vamos acrescentar linhas de sombreamento no nosso gráfico. Para isso, basta usar o comando density = 40.*

````{r Hist03}
hist(Vendas, density = 40)
```

*Para mudar a angulação das linhas de sombreamento, vamos usar o comando angle que irá alterar. Neste exemplo, vamos colocar angle igual a 50.*
...
*Podemos acrescentar cores as barras do nosso histograma através do comando col.*
...
*Se você quiser retirar as bordas mas manter as cores das barras, basta que no comando border coloque igual a False.*
