...
No vídeo de hoje, iremos aprender como fazer o **Box-Plot**. (Definição)
...
*Agora, iremos acrescentar informações ao Box-Plot. Para adicionar título ao gráfico, basta usar o comando main e para o eixo y usaremos ylab.*

```{r Box01}
boxplot(altura, main = "Altura", ylab = "Centímetros")
```

*Se queremos iniciar e terminar entre os valores máximo e mínimo da amostra mesmo que sejam outliers, o comando range irá fazer isto. Neste caso, faremos range igual a 0. Vejamos:*
